...
ANTHROPIC_API_KEY = GLOBALS.ANTHROPIC_API_KEY
...
class APIInterface:
    ...
    def parse_request(self):
        ...
        if service == "geocoding":
            ...
            self.anthropic(self.request["data"])
    ...
    def anthropic(self, data=None):
        """
        Calls the anthropic API to generate a request with AI.
        """
